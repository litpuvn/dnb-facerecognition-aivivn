...
def my_process(pair):
    emb1 = np.load('../dlib-19.17/embedding/test/%s'%pair.img1_path.replace('.png', '.npy'))
    emb2 = np.load('../dlib-19.17/embedding/train/%s'%pair.img2_path.replace('.png', '.npy'))
...
if __name__ == '__main__':
    ...
    test_df.to_csv('dlib.csv', index = False)
